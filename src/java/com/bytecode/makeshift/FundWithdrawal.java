 ...
 * @author Ahmed
 */
@WebServlet(name="WebPortal_FundWithdrawal", urlPatterns={"/WebPortal/FundWithdrawal"})
public class FundWithdrawal extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try{
            ...
            withdrawalResponse.setDescription(ResponseCode.Invalid_request);
        }
        ...
        Gson gson=new Gson();
        out.println(gson.toJson(withdrawalResponse));
        out.close();
   ...
   manager= new ConManager(new AdminRepositoryImpl());
    ...
    throws ServletException, IOException {
        ...
        WithdrawalResponse withdrawalResponse = new WithdrawalResponse(); 
        try{
       withdrawalResponse.setResponseCode(ResponseCode.METHODNOTALLOWED);
       withdrawalResponse.setDescription(ResponseCode.METHOD_NOT_ALLOWED);
