...
public class LoanDTO {
    ...
    private String lastTurnover, businessNature, businessYr,
    tenancyInvoice, landlordName, propertyAddres, landlordBankName, landlordAccountNo,
    childName, childSchool, schoolBankName, schoolAccountNo, schoolfeeInvoice;
